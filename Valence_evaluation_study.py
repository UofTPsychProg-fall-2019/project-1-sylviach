...
expName = 'Valence_evaluation_study'
expInfo = {'Participant No.*': '', 'Age*': '', 'Gender*': '', 'The year you are in undergraduate study*': ''}
...
filename = _thisDir + os.sep + u'data/%s_%s_%s' % (expInfo['Participant No.*'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='C:\\Users\\XiaoMin\\Documents\\PSY1210_2019\\Project_1\\Valence_evaluation_study.py',
...
text_7 = visual.TextStim(win=win, name='text_7',
    text="""    Beginning on the next page, you will read a series of brief descriptions of people. 
    
    Read the descriptions very carefully. They will reveal a specific characteristic for you to consider (e.g., the person might be described as “kind” or "mean"). 

    You will be asked to indicate whether the described characteristic is positive or negative.

    For this question, you will reply using a scale from 1 to 7:
    ...
    When you are ready, press SPACE BAR to start.""",
...
Rating_response = visual.Slider(win=win, name='Rating_response',
    size=(500, 20), pos=(0, -200), units='pix',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Very negative',
    font='Hevetica',
    pos=(-420, -200), height=25, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-2.0);
text_3 = visual.TextStim(win=win, name='text_3',
    text='Very Positive',
    font='helvetica',
    pos=(400, -200), height=25, wrapWidth=None, ori=0, 
    color='black', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-3.0);
...
InstructionsComponents = [text_7, key_resp]
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('Valence_evaluation_materials.xlsx'),
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    ExperimentComponents = [text, Rating_response, text_2, text_3]
    ...
    while continueRoutine:
        ...
        # Check Rating_response for response to end routine
        if Rating_response.getRating() is not None and Rating_response.status == STARTED:
            continueRoutine = False
    ...
    trials.addData('Rating_response.response', Rating_response.getRating())
    trials.addData('Rating_response.rt', Rating_response.getRT())
    trials.addData('Rating_response.started', Rating_response.tStartRefresh)
    trials.addData('Rating_response.stopped', Rating_response.tStopRefresh)
...
key_resp_2.rt = []
# keep track of which components have finished
The_endComponents = [text_8, key_resp_2]
